...
class SettingsRepository {
  ...
  ///
  /// When loading a record written before Step 8, [HiveSettingsModelAdapter]
  /// already handles the missing fields by returning `true` as defaults for
  /// [showTransliteration] and [showCommentary].
  SettingsState load() {
    ...
    return SettingsState(
      ...
      showTransliteration: model.showTransliteration,
      showCommentary: model.showCommentary,
    );
  }

  /// Persists [state] to Hive asynchronously.
  Future<void> save(SettingsState state) async {
    await _box.put(
      ...
      HiveSettingsModel(
        ...
        showCommentary: state.showCommentary,
      ),
    );
  }
}