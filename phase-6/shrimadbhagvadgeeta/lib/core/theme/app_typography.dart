...
abstract final class AppTypography {
  ...
  /// Returns [base] with its [fontSize] multiplied by [scale].
  ///
  /// This is the ONLY place font-size multiplication occurs.
  /// Callers: [ReadingStyles] only.
  ///
  /// ⚠️  DO NOT call this from widgets directly.
  ///     Widgets must consume [readingStylesProvider] instead.
  static TextStyle scaled(TextStyle base, double scale) {
    if (scale == 1.0) return base;
    return base.copyWith(fontSize: (base.fontSize ?? 16.0) * scale);
  }
